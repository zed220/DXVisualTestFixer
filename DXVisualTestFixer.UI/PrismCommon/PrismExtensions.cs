...
namespace DXVisualTestFixer.UI.PrismCommon {
	public static class PrismExtensions {
		...
		public static void SetViewModel(DependencyObject element, BindableBase value) {
			element.SetValue(ViewModelProperty, value);
		}

		public static BindableBase GetViewModel(DependencyObject element) {
			return (BindableBase) element.GetValue(ViewModelProperty);
		}
	}
}